...
public abstract class BaseTextMsgListener implements TextMsgListener {
    ...
    public void onRecvTextMsg(TextMsg txtMsg) {
        ...
        switch (msgType) {
            ...
            case MESSAGE:
                ...
                break;
            case MESSAGE_OK:
                int channel = Integer.parseInt(txtMsg.getcallTel());
                notifySendMessageSuc(channel);
                break;
            default:
                channel = Integer.parseInt(txtMsg.getcallTel());
                notifySendMessageFail(channel);
                break;
        }
    }
     ...
     */
    protected abstract void notifySendMessageSuc(int channel);
     ...
     * @param channel 发送消息时返回的值一一对应
     */
    protected abstract void notifySendMessageFail(int channel);
}
