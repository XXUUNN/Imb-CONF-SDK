...
public class UserChangeInMeeting {
    ...
    private String onlineUidList;

    public UserChangeInMeeting(int type, String caller, String onlineUidList, String flag) {
        this.type = type;
        this.caller = caller;
        this.onlineUidList = onlineUidList;
        this.flag = flag;
    }
    ...
    public String getOnlineUidList() {
