...
import com.imb.sdk.util.DateUtils;
...
public class RecordCallRequest {
    ...
    public RecordCallRequest(long callerId, String callerName, String callerTel,
                             ...
                             long callTime, long answerTime, long endTime, long length, @PocConstant.CallType int callType, @PocConstant.ContactType int contactType) {
        ...
        if (contactType == PocConstant.ContactType.TYPE_PERSON) {
        ...
        } else if (contactType == PocConstant.ContactType.TYPE_GROUP) {
            if (callType == PocConstant.CallType.CALL_VOICE_TWO_WAY) {
                //语音会议
                this.callType = 5;
